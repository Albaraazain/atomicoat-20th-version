...
class _ComponentControlOverlayState extends State<ComponentControlOverlay> {
  ...
  void _resetPositions() {
    ...
    final center = Offset(_overlaySize!.width / 2, _overlaySize!.height / 2);
    final componentSize = 30.0; // Assuming a default size for the components
    final adjustedCenter = Offset(center.dx - componentSize / 2, center.dy - componentSize / 2);
    setState(() {
      _componentPositions = {
        'Nitrogen Generator': adjustedCenter,
        'MFC': adjustedCenter,
        'Valve 1': adjustedCenter,
        'Valve 2': adjustedCenter,
        'Reaction Chamber': adjustedCenter,
        'Pressure Control System': adjustedCenter,
        'Vacuum Pump': adjustedCenter,
        'Precursor Heater 1': adjustedCenter,
        'Precursor Heater 2': adjustedCenter,
        'Frontline Heater': adjustedCenter,
        'Backline Heater': adjustedCenter,
      };
    });
